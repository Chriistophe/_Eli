...
void zza(void)
{
  typedef int form_itf_cpt;
  form_itf_cpt cpt_larg=0;
  form_itf_cpt cpt_haut=0;
  char sep=197;

  //  map<string, int>::const_iterator iter;
  for( iter=g_TokenLookup.begin(); iter != g_TokenLookup.end(); ++iter)
  {
    string c,h=iter->first;
    int z;
    h.resize(15,' ');
    cout<<h;  //  <<" || ";
    z=iter->second.token;
  ...
  //  c.resize(5,' ');
  //  cout <<c<<" ";
    cout <<iter->second.sz <<endl;
  //  if (cpt_larg++ %2==0) cout<<endl;
  //  if (cpt_haut++ %73 ==0) _getch();
  }_getch();
}*/
